...
static const char *fonts[]          = { "FiraCode:size=20" };
static const char dmenufont[]       = "FiraCode:size=20";
...
static const char *dmenucmd[] = { "rofi", "-combi-modi", "drun,ssh", "-show", "drun", "-show-icons", NULL };
